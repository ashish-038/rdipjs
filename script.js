...
var x=Math.floor(Maath.randam()*1000);
var y=Math.floor(Maath.randam()*1000);
var a=x%3;
var b=y%3;
if(a==0&&b==1 ||a==1 && b==0)
alert("human survive"+" "+x+""+y);
else if(a==0&&b==2 ||a==2 && b==0)
alert("human died"+" "+x+""+y);
else if(a==1&&b==2 ||a==2 && b==1)
alert("cockroach lives"+" "+x+""+y);
else if(a==b)
alert("TIE"+" "+x+" "+y);
}
function validateAnagramm() {
